			...
			<div class="container_12 framing">
				<div class="grid_12">
					...
					<div class="rep-container">
						<?php $this->load->view('forms/frmspecialslist'); ?>
						<div id="frmInsNews" style="display:none;">
							<?php $this->load->view('forms/frminsspecials');?>
						</div>
		...
		$(document).ready(function(){
			...
			$("#insNews").click(function(){
				...
				if($("#frmInsNews").is(":hidden")){
					...
					var height = ($(window).height()*$(".box").size());
			...
			$(".NewsDel").click(function(){
				...
				$.post(
					"<?=$baseurl;?>managers/delete-specials/<?=$userinfo['uconfirmation'];?>",
					{'id':newsID},
					function(data){
						if(data.status){
			...
			$(".NewsSave").click(function(){
				...
				if(err){
					...
					$.post("<?=$baseurl;?>managers/save-specials/<?=$userinfo['uconfirmation'];?>",
