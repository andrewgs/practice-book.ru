...
<!--[if (gt IE 9)|!(IE)]><!--> <body> <!--<![endif]-->
		...
		<div id="main">
			<section id="info-boxes">
				...
				<input type="button" id="questions" title="Редактировать" class="box-controls edit" style="width:10px;height:16px;border:none">
						...
						<?php for($i=0;$i<count($questions);$i++):?>
							<div id="pitfalls-modal-content" Quest="<?=$i;?>">
								<div class="box">
									<div class="box-header">&nbsp;
										<div class="box-search">
								...
								<div class="box">
									...
									<?php for($i=0;$i<count($company['all']);$i++):?>
										<div class="content-separator">
											...
											<div class="RightLink">
												<a href="#" class="window">На страницу компании</a>
											</div>
											<div class="clear"></div>
										</div>
									<?php endfor; ?>
					...
					<div class="grid_3 omega w240"> 
						<div class="box">
							...
							<div class="box-bottom-links h20">
								...
								<!--<div class="left">
									<?php $link = 'send-email/manager/'.$userinfo['uid']; ?>
									<?php $text = '<img src="'.$baseurl.'images/email.png"/>'; ?>
									<?php $attr = array('title'=>'Отправить менеджеру личное сообщение'); ?>
			...
			<input type="button" id="documents" title="Редактировать" class="box-controls edit" style="width:10px;height:16px;border:none">
							...
							<div class="box-bottom-links h20">
								<!--<div class="left">
									<?= anchor('manager/add-document/'.$userinfo['uconfirmation'],'Загрузить &raquo;');?>
								</div>-->
								<div class="right">
	...
	<script type="text/javascript">
		...
		$("a#winQuestion").click(function(e){
			...
			$("#pitfalls-modal-content[Quest='"+quest+"']").modal();
			return false;
		});
