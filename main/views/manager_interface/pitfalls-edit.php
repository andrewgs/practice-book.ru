			...
			<div class="container_12 framing">
				<div class="grid_12">
					...
					<div class="rep-container">
						<?php $this->load->view('forms/frmpitfallslist'); ?>
						<div id="frmInsPitFalls" style="display:none;">
							<?php $this->load->view('forms/frminspitfall');?>
						</div>
	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			$(".NewsDel").click(function(){
				...
				$.post(
					"<?=$baseurl;?>managers/delete-pitfalls/<?=$userinfo['uconfirmation'];?>",
					{'id':newsID},
					function(data){
						if(data.status){
			...
			$(".NewsSave").click(function(){
				...
				if(err){
					...
					$.post("<?=$baseurl;?>managers/save-pitfalls/<?=$userinfo['uconfirmation'];?>",
