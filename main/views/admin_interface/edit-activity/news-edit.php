			...
			<div class="container_12 framing">
				<div class="grid_12">
					...
					<div class="rep-container">
						<?php $this->load->view('forms/frmnewslist'); ?>
						<div id="frmInsNews" style="display:none;">
							<?php $this->load->view('forms/frminsnews');?>
						</div>
	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			$(".NewsDel").click(function(){
				...
				$.post(
					"<?=$baseurl;?>admin/delete-news/<?=$userinfo['uconfirmation'];?>",
					{'id':newsID},
					function(data){
						if(data.status){
			...
			$(".NewsSave").click(function(){
				...
				if(err){
					...
					$.post("<?=$baseurl;?>admin/save-news/<?=$userinfo['uconfirmation'];?>",
