		...
		<div id="main">
			<div class="container_12 framing">
				<div class="grid_12">
					...
					<?php $this->load->view('admin_interface/price-coordinator/select-lists'); ?>
					<div id="frmInsProductUnit" style="display:none;">
						<?php $this->load->view('admin_interface/price-coordinator/insproductunit');?>
					</div>
					...
					<div id="frmInsProductGroup" style="display:none;">
						<?php $this->load->view('admin_interface/price-coordinator/insproductgroup');?>
					</div>
							...
							$("#select-products").live('change',function(){
								...
								if($("#select-products").val()>0){
									...
									$("#select-unit").live('click',function(){
										$("#formUnit").load("<?=$baseurl;?>admin-listbox/product-unit-form/<?=$userinfo['uconfirmation'];?>",
											...
											function(){
												...
												$("#UnitDel").live('click',function(event){
													event.preventDefault();
													$.post(
														"<?=$baseurl;?>admin/product-unit-dalete/<?=$userinfo['uconfirmation'];?>",
														{'group':$("#select-group").val(),'unit':$("#select-products").val()},
														function(data){
															if(data.status){
																$("#select-unit").die();
