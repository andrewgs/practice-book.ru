<table class="price-table table-dash">
	<thead>
		<tr>
			<th width="450px">Наименование популярной позиции</th>
	...
	<tbody>
		<tr>
			<td>
				...
				<input class="edit350-form-input" id="uptitle" name="title" disabled="disabled" type="text" value="<?=$unit['cu_title'];?>"/>
				<label class="label-input">Описание:</label>
				<textarea class="edit350-form-textarea" name="note" cols="20" disabled="disabled" rows="5"><?=strip_tags($unit['cu_note']);?></textarea>
			</td>
			<td>
				...
				<select class="select-price" id="cupricecode" name="pricecode" disabled="disabled">
				...
				<select class="medium-select-price" name="unitscode" disabled="disabled">
		...
		<tr>
			...
			<td>
				<div class="ButtonOperation">
					...
					<button title="Сохранить" class="NewsSave" name="subsavene" id="UnitSave"  value=" Сохранить">
