						...
						<div class="content-right-bot">
							...
							<div class="right-text">
								<div class="add_events">
									<a href="#" title="Создать обсуждение"><img src="<?=$baseurl;?>images/add_events2.png" alt="Создать обсуждение" /></a>
								</div>
								<div class="right-post">
									<h2>оПТОВАЯ ТОРГОВЛЯ В мОСКВЕ</h2>
