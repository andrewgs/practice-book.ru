...
<?=anchor('business-environment/activity-discounts/'.$userinfo['uconfirmation'].'/create-discount','<img src="'.$baseurl.'images/add_news.png" alt="добавить новинку"/>',array('title'=>'добавить новинку'));?>
							<?php endif; ?>
								<?php if(count($topics)):?>
									<span class="sort">
										Сортировать:
