						...
						<div class="content-right-bot">
							...
							<div class="right-text">
								<div class="add_events">
									<?=anchor('business-environment/interactions/'.$userinfo['uconfirmation'].'/create-interaction','<img src="'.$baseurl.'images/add_events2.png" alt="Создать обсуждение"/>',array('title'=>'Создать обсуждение'));?>
								</div>
							<?php for($i=0;$i<count($topics);$i++):?>
								<div class="right-post">
									<h2><?=$topics[$i]['itp_title'];?></h2>
									<span class="date"><?=$topics[$i]['itp_date'];?></span>
...
<?=anchor('business-environment/interactions/'.$userinfo['uconfirmation'].'/delete-interaction/'.$topics[$i]['itp_id'],'Удалить',array('title'=>'Удалить'));?>
												...
												<td class="right-avtor">
													<table cellspacing="0" cellpadding="0">
														<tr>
				<td><img src="<?=$baseurl;?>cravatar/viewimage/<?=$topics[$i]['itp_usrid'];?>" alt="" align="left" width="42" height="42"/></td>
