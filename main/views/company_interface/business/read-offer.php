					...
					<div class="content-center-box">
						...
						<div class="content-text">
							...
							<div class="right-post zakup zakup2">
								...
								<p><?=$topic['oft_note'];?></p>
								<span class="green">
						<?=anchor('business-environment/offers/'.$userinfo['uconfirmation'].'/offer/'.$topic['oft_id'].'/comment','ответить');?>
								</span>
								<div class="clear">&nbsp;</div>
...
<?=anchor('business-environment/offers/'.$userinfo['uconfirmation'].'/track-offer/'.$topic['oft_id'],'Отслеживать',array('title'=>'Отслеживать'));?>
<?=anchor('business-environment/offers/'.$userinfo['uconfirmation'].'/share-offer/'.$topic['oft_id'],'Поделиться',array('title'=>'Поделиться'));?>
...
<?=anchor('business-environment/offers/'.$userinfo['uconfirmation'].'/offer/'.$this->uri->segment(5).'/edit-comment/'.$comments[$i]['cmn_id'],'Редактировать');?>
