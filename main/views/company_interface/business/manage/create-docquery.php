...
<!--[if (gt IE 9)|!(IE)]><!--> <body> <!--<![endif]-->
		...
		<div id="main" class="whitebg">
			<div class="contentblock">
				...
				<div class="content-right">
					...
					<label class="label-input">Содержание запроса: <span class="necessarily" title="Поле не может быть пустым">*</span></label>
									<?= form_error('title'); ?>
					<textarea class="edit700-form-textarea" name="title" id="title" cols="50" rows="10"><?=set_value('title');?></textarea>
									<div class="clear"></div>
	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			$("#addDiscussion").click(function(event){$("#title").css('border-color','#D0D0D0');if($("#title").val() == ''){$("#title").css('border-color','#ff0000');msgerror("Пропущены обязательные поля!");event.preventDefault();}});
