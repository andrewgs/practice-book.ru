...
<!--[if (gt IE 9)|!(IE)]><!--> <body> <!--<![endif]-->
			...
			<div class="contentblock">
				...
				<div class="content-right">
					...
					<textarea class="edit700-form-textarea" name="title" id="title" cols="50" rows="10"><?=set_value('title');?></textarea>
									<div class="clear"></div>
						<input class="btn-action margin-1em" id="addQuestion" type="submit" name="submit" value="Добавить"/>
								<?= form_close(); ?>
								</div>
							</div>
						</div>
	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			$("#addQuestion").click(function(event){$("#title").css('border-color','#D0D0D0');if($("#title").val() == ''){$("#title").css('border-color','#ff0000');msgerror("Пропущены обязательные поля!");event.preventDefault();}});
