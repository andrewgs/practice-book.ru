			...
			<div class="contentblock">
				...
				<div class="content-right">
					...
					<label class="label-input">Название: <span class="necessarily" title="Поле не может быть пустым">*</span></label>
									<?= form_error('title'); ?>
					<input class="edit450-form-input" id="title" maxlength="150" name="title" type="text" value="<?=$topic['itp_title'];?>"/>
									<div class="clear"></div>
					<label class="label-input">Содержание: <span class="necessarily" title="Поле не может быть пустым">*</span></label>
									<?= form_error('note'); ?>
					<textarea class="edit700-form-textarea" name="note" id="note" cols="50" rows="10"><?=$topic['itp_note'];?></textarea>
									<div class="clear"></div>
