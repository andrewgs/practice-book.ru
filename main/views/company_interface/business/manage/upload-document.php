					...
					<div class="content-right-top">
						<div class="content-right-bot">
							...
							<label class="label-input">Описание: <span class="necessarily" title="Поле не может быть пустым">*</span></label>
								<?= form_error('note'); ?>
					<textarea class="edit700-form-textarea inpvalue" name="note" id="note" cols="50" rows="5"><?=set_value('note');?></textarea>
	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			$("#addDocument").click(function(event){
				...
				if($("#userfile").val() == ''){err = true;$("#userfile").css('border-color','#ff0000');}
