<div class="container_12 framing">
	<div class="grid_12">
		...
		<div class="grid_5">
			...
			<div class="clear"></div>
			Фамилия: <div class="vRight" id="dname"><?=$manager['uname'];?></div><br>
			...
			<div class="clear"></div>
			Имя: <div class="vRight" id="dsubname"><?=$manager['usubname'];?></div><br>
			...
			<div class="clear"></div>
			Отчество: <div class="vRight" id="dthname"><?=$manager['uthname'];?></div><br>
