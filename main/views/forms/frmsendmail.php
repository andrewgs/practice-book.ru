<?= form_open('send-manager-email',array('class'=>'formular')); ?>
	<?=form_hidden('uri',$this->uri->uri_string());?>
	<?=form_hidden('manmail',$manager['uemail']);?>
	<div class="box">
		<div class="box-header"><b>Отправить менеджеру сообщение</b>
		...
		<div class="box-content w575">
			...
			<div class="clear"></div>
			<div class="grid_2">
				<input class="btn-action" id="SendEmail" type="submit" name="submit" value="Отправить"/>
			</div>
			<div class="clear"></div>
		</div>
